...
const CandlestickChart = ({
  ...
  const chandleSeriesRef = useRef<ISeriesApi<"Candlestick"> | null>(null);
  ...
  const fetchOHLCData = async (selectedPeroid: Period) => {
    try {
      const { days, interval } = PERIOD_CONFIG[selectedPeroid];
